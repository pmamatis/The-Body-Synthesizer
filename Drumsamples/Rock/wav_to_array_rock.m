...
%% HIHAT
[hh,hh_SR] = audioread('Rock_Hihat.wav');
...
%% KICK
[kick,kick_SR] = audioread('Rock_Kick.wav');
...
%% Ride
[ride,ride_SR] = audioread('Rock_Ride.wav');
...
%% Snare
[snare,snare_SR] = audioread('Rock_Snare.wav');

...
Definition at line \mbox{\hyperlink{signal__synthesis_8c_source_l01353}{1353}} of file \mbox{\hyperlink{signal__synthesis_8c_source}{signal\+\_\+synthesis.\+c}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{01353                            \{}
\DoxyCodeLine{01354 }
\DoxyCodeLine{01355     \textcolor{keywordtype}{float} temp1;}
\DoxyCodeLine{01356     \textcolor{keywordtype}{float} temp2;}
\DoxyCodeLine{01357     \textcolor{keywordtype}{float} result;}
\DoxyCodeLine{01358     \textcolor{keywordtype}{int} p;}
\DoxyCodeLine{01359 }
\DoxyCodeLine{01360     p = 1;}
\DoxyCodeLine{01361 }
\DoxyCodeLine{01362     \textcolor{keywordflow}{while}( p > 0 )}
\DoxyCodeLine{01363     \{}
\DoxyCodeLine{01364         temp2 = ( rand() / ( (float)RAND\_MAX ) ); \textcolor{comment}{/*  rand() function generates an }}
\DoxyCodeLine{01365 \textcolor{comment}{                                                       integer between 0 and  RAND\_MAX, }}
\DoxyCodeLine{01366 \textcolor{comment}{                                                       which is defined in stdlib.h. }}
\DoxyCodeLine{01367 \textcolor{comment}{         */}}
\DoxyCodeLine{01368 }
\DoxyCodeLine{01369         \textcolor{keywordflow}{if} ( temp2 == 0 )}
\DoxyCodeLine{01370         \{\textcolor{comment}{// temp2 is >= (RAND\_MAX / 2)}}
\DoxyCodeLine{01371             p = 1;}
\DoxyCodeLine{01372         \}\textcolor{comment}{// end if}}
\DoxyCodeLine{01373         \textcolor{keywordflow}{else}}
\DoxyCodeLine{01374         \{\textcolor{comment}{// temp2 is < (RAND\_MAX / 2)}}
\DoxyCodeLine{01375             p = -\/1;}
\DoxyCodeLine{01376         \}\textcolor{comment}{// end else}}
\DoxyCodeLine{01377 }
\DoxyCodeLine{01378     \}\textcolor{comment}{// end while()}}
\DoxyCodeLine{01379 }
\DoxyCodeLine{01380     temp1 = cos( ( 2.0 * (\textcolor{keywordtype}{float})PI ) * rand() / ( (\textcolor{keywordtype}{float})RAND\_MAX ) );}
\DoxyCodeLine{01381     result = sqrt( -\/2.0 * log( temp2 ) ) * temp1;}
\DoxyCodeLine{01382 }
\DoxyCodeLine{01383     \textcolor{keywordflow}{return} result;  \textcolor{comment}{// return the generated random sample to the caller}}
\DoxyCodeLine{01384 }
\DoxyCodeLine{01385 \}\textcolor{comment}{// end AWGN\_generator()}}
...
\DoxyCodeLine{01269     \textcolor{keywordflow}{if}(\mbox{\hyperlink{group__SINLUT_ga1380f2886548602aeb7849aa7ba76435}{LUT\_SUPPORTPOINTS}}[signals-\/>freqIndex[index]] \% 2 == 0)\{}
\DoxyCodeLine{01270 }
\DoxyCodeLine{01271         \textcolor{comment}{// IF: Current index < length of period of desired frequency (0:172 < 173)}}
\DoxyCodeLine{01272         \textcolor{keywordflow}{if}(signals-\/>current\_LUT\_Index[index] < (\mbox{\hyperlink{group__SINLUT_ga1380f2886548602aeb7849aa7ba76435}{LUT\_SUPPORTPOINTS}}[signals-\/>freqIndex[index]] / 2))\{}
\DoxyCodeLine{01273 }
...
\DoxyCodeLine{01277         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(signals-\/>current\_LUT\_Index[index] >= (\mbox{\hyperlink{group__SINLUT_ga1380f2886548602aeb7849aa7ba76435}{LUT\_SUPPORTPOINTS}}[signals-\/>freqIndex[index]] / 2))\{}
\DoxyCodeLine{01278 }
\DoxyCodeLine{01279             rect = -\/0.2;}
\DoxyCodeLine{01280         \}}
\DoxyCodeLine{01281     \}}
\DoxyCodeLine{01282     \textcolor{comment}{// IF: Length of period is odd (e.g. 347)}}
\DoxyCodeLine{01283     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(\mbox{\hyperlink{group__SINLUT_ga1380f2886548602aeb7849aa7ba76435}{LUT\_SUPPORTPOINTS}}[signals-\/>freqIndex[index]] \% 2 == 1)\{}
\DoxyCodeLine{01284 }
\DoxyCodeLine{01285         \textcolor{comment}{// IF: Current index < length of period of desired frequency (0:173 < 174) due to (period-\/1)/2 + 1}}
\DoxyCodeLine{01286         \textcolor{keywordflow}{if}(signals-\/>current\_LUT\_Index[index] < (((\mbox{\hyperlink{group__SINLUT_ga1380f2886548602aeb7849aa7ba76435}{LUT\_SUPPORTPOINTS}}[signals-\/>freqIndex[index]] -\/ 1) / 2) + 1))\{}
\DoxyCodeLine{01287 }
...
\DoxyCodeLine{01291         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(signals-\/>current\_LUT\_Index[index] >= (((\mbox{\hyperlink{group__SINLUT_ga1380f2886548602aeb7849aa7ba76435}{LUT\_SUPPORTPOINTS}}[signals-\/>freqIndex[index]] -\/ 1) / 2) + 1))\{}
\DoxyCodeLine{01292 }
...
\DoxyCodeLine{01310     \textcolor{keywordtype}{float} period        = (\textcolor{keywordtype}{float})\mbox{\hyperlink{group__SINLUT_ga1380f2886548602aeb7849aa7ba76435}{LUT\_SUPPORTPOINTS}}[signals-\/>freqIndex[index]];}
\DoxyCodeLine{01311 }
...
\DoxyCodeLine{01159             \mbox{\hyperlink{group__DrumComputer_ga08535ad247ef4e17b91bbba4b56833af}{Drum\_Computer\_Process}}();}
\DoxyCodeLine{01160             drums\_filtered = drums;}
\DoxyCodeLine{01161             \textcolor{keywordflow}{if}(Display.Drumfilter\_ONOFF)}
\DoxyCodeLine{01162                 \mbox{\hyperlink{group__Filter_gad95e18a35a0ebacf27bc67222a71e275}{ProcessFilter}}(\&LS\_DRUMS, \&drums\_filtered);}
\DoxyCodeLine{01163         \}}
...
\DoxyCodeLine{01171             \mbox{\hyperlink{group__EffectProcessing_ga3f7370371217adca4b93419901dc1c1f}{keyboard\_adsr\_process}}();}
...
\DoxyCodeLine{01179             \mbox{\hyperlink{group__SingleSample_gab788a1e344e6956cb70a8e5e1ea4d0bd}{PlaySingleSample}}();}
\DoxyCodeLine{01180             calculate\_vector\_tmp[BLOCKSIZE\_counter] += single\_sample;}
\DoxyCodeLine{01181         \}}
\DoxyCodeLine{01182 }
...
\DoxyCodeLine{01187             \mbox{\hyperlink{group__EffectProcessing_ga3f7370371217adca4b93419901dc1c1f}{keyboard\_adsr\_process}}();}
...
Definition at line \mbox{\hyperlink{signal__synthesis_8c_source_l01213}{1213}} of file \mbox{\hyperlink{signal__synthesis_8c_source}{signal\+\_\+synthesis.\+c}}.

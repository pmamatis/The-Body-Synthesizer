...
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00020}\mbox{\hyperlink{distortion_8h_a54ad82c4a3ecbc0c2784ae81c92eb22e}{00020}} Distortion\_Status \mbox{\hyperlink{distortion_8c_a54ad82c4a3ecbc0c2784ae81c92eb22e}{Distortion\_Init}}(\textcolor{keywordtype}{void}) \{}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00021}00021 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00022}00022     \mbox{\hyperlink{distortion_8c_a2a6725ec967773f5ddfbc3fc21d67049}{SetupHardClippingDistortion}}(\&HardClipping);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00023}00023     \mbox{\hyperlink{distortion_8c_a8a375c625074dc4492066cda7e9e175b}{SetupSoftClippingDistortion}}(\&SoftClipping);}
...
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00033}\mbox{\hyperlink{distortion_8h_ac69b82a1179f795d9205a246de59a37a}{00033}} Distortion\_Status \mbox{\hyperlink{distortion_8c_ac69b82a1179f795d9205a246de59a37a}{Distortion\_Reset}}(\textcolor{keywordtype}{void}) \{}
...
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00055}\mbox{\hyperlink{distortion_8h_a2a6725ec967773f5ddfbc3fc21d67049}{00055}} Distortion\_Status \mbox{\hyperlink{distortion_8c_a2a6725ec967773f5ddfbc3fc21d67049}{SetupHardClippingDistortion}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structeffects__distortion}{effects\_distortion}}* HardClipping) \{}
...
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00069}\mbox{\hyperlink{distortion_8h_a8a375c625074dc4492066cda7e9e175b}{00069}} Distortion\_Status \mbox{\hyperlink{distortion_8c_a8a375c625074dc4492066cda7e9e175b}{SetupSoftClippingDistortion}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structeffects__distortion}{effects\_distortion}}* SoftClipping) \{}
...
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00096}\mbox{\hyperlink{distortion_8h_a7a68b2a90c4306d739161ee82b7eb89c}{00096}} Distortion\_Status \mbox{\hyperlink{distortion_8c_a7a68b2a90c4306d739161ee82b7eb89c}{ProcessHardClippingDistortion}}(\textcolor{keywordtype}{float}* data) \{}
...
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00121}\mbox{\hyperlink{distortion_8h_a1676e7551d7621b89efb0ecc46092436}{00121}} Distortion\_Status \mbox{\hyperlink{distortion_8c_a1676e7551d7621b89efb0ecc46092436}{ProcessSoftClippingDistortion}}(\textcolor{keywordtype}{float}* data) \{}
...
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00130}00130     SoftClipping.distortion\_index = round(SoftClipping.atan\_parameter/aquidistance);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00131}00131     calc = 0.5*\mbox{\hyperlink{atanLUT_8h_a44717ae85351202c8833c3880a6ef9e8}{atan\_LUT\_y}}[SoftClipping.distortion\_index]; \textcolor{comment}{// scale down the amplitude}}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00132}00132 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00133}00133     \textcolor{keywordflow}{if}(0.0 <= SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 1.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00134}00134         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[0]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00135}00135 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00136}00136     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(1.0 < SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 2.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00137}00137         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[1]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00138}00138 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00139}00139     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(2.0 < SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 3.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00140}00140         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[2]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00141}00141 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00142}00142     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(3.0 < SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 4.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00143}00143         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[3]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00144}00144 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00145}00145     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(4.0 < SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 5.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00146}00146         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[4]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00147}00147 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00148}00148     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(5.0 < SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 6.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00149}00149         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[5]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00150}00150 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00151}00151     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(6.0 < SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 7.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00152}00152         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[6]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00153}00153 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00154}00154     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(7.0 < SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 8.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00155}00155         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[7]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00156}00156 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00157}00157     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(8.0 < SoftClipping.distortion\_gain \&\& SoftClipping.distortion\_gain <= 9.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00158}00158         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[8]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00159}00159 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00160}00160     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(SoftClipping.distortion\_gain > 9.0)}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00161}00161         calc = calc * (1.f/SoftClipping.atan\_softclipping\_distortion\_max[9]);}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00162}00162 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00163}00163     *data = calc;}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00164}00164 }
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00165}00165     \textcolor{keywordflow}{return} DISTORTION\_OK;}
\DoxyCodeLine{\Hypertarget{distortion_8c_source_l00166}00166 \}}
